...
def submit_report():
    ...
    new_item = Item(
            ...
            # This will save 'Admin' if logged in via admin portal
    ...
    if report_type == 'Found' and target_id:
        # Create a message for the probable owner
        auto_msg = Message(
            item_id=new_item.id,
            sender_id="System",
            receiver_id=target_id,
            content=f"An item matching your ID was found at {location}. Is this yours?"
        )
